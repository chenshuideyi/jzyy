...
public class LightningWormChitin {

    public static class lightningabsorption extends Modifier implements OnAttackedModifierHook, ModifyDamageModifierHook {
        ...
        private boolean isLIGHTNINGDamage(DamageSource source) {
            ...
            return damageType.is(DamageTypeTags.IS_LIGHTNING);
        }
    }
}
