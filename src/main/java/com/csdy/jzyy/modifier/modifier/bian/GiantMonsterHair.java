...
public class GiantMonsterHair {

    public static class frostabsorption extends Modifier implements OnAttackedModifierHook, ModifyDamageModifierHook {
        ...
        private boolean isFreezingDamage(DamageSource source) {
            Holder<DamageType> damageType = source.typeHolder();
            return damageType.is(DamageTypeTags.IS_FREEZING);
        }
    }
}