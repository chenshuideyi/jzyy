...
public class ColorLightningRenderer2 extends LightningBoltRenderer {
    public float[] colors = new float[]{0.45F, 0.45F, 0.5F};
    public ColorLightningRenderer2(EntityRendererProvider.Context context) {
        super(context);
    }
        ...
        for (int j = 0; j < 4; ++j) {
            ...
            for (int k = 0; k < 3; ++k) {
                ...
                for (int j1 = l; j1 >= i1; --j1) {
                    ...
                    float alpha = 1.0F;
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 111, 123, 32, alpha, f11, false, false, true, false);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 111, 123, 32, alpha, f11, true, false, true, true);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 111, 123, 23, alpha, f11, true, true, false, true);
                    quad(matrix4f, vertexconsumer, f2, f3, j1, f4, f5, 111, 123, 32, alpha, f11, false, true, false, false);
                }
            }
        }
