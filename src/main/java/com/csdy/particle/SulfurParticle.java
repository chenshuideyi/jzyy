...
public class SulfurParticle extends TextureSheetParticle {
    ...
    protected SulfurParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SulfurParticle particle = new SulfurParticle(level, x, y, z, xSpeed, ySpeed, zSpeed);
